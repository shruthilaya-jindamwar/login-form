  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-zinc-50 dark:bg-black">
      <div className="flex flex-col-reverse md:flex-row items-center w-full max-w-4xl gap-2 px-4">
        {/* illustration on left for md+ screens */}
        <div className="w-full md:w-1/2 flex justify-center relative">
          <div className="w-48 h-48 md:w-64 md:h-64">
            {/* replace "/avatar.png" with your cartoon image file placed in public/ */}
            <Image
              src="/avatar.png"
        ...
        <h2 className="text-2xl font-bold mb-6 text-center text-zinc-900 dark:text-zinc-50">Sign in</h2>
